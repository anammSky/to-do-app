...
import fetchPostOneTask from "./utils/tasks/fetchPostOneTask";
...
export default function AddTask(props) {
    ...
    function handleSubmit(event) {
        ...
        fetchPostOneTask(userId, formData.title, formData.content);
        props.handleClick();
    }
    return (
        <section className="add-task__container">
            <form className="add-task__form">
                ...
                <section className="add-task__section__btn">
                    <button onClick={handleSubmit} className="btn add-task__btn" id="btnAdd-task">
                        Add
                    </button>
                    <button onClick={props.handleClick} className="btn btn--danger login__btn">
                        Cancel
                    </button>
                </section>
            </form>
